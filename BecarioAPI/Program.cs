...
try
{
    ...
    {
        options.UseSqlServer("Data Source=Navarrete; Initial Catalog=BecarioDB;Integrated Security=True;Connect Timeout=60;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    });
